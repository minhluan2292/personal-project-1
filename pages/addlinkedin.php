...
<!-- <h1 style="color:white;margin:10px;background:green;"><marquee scrollamount="25" behavior="alternate">LAM 4 SCOOP KHONG CO TIME XEM</marquee></h1>
 -->
...
<!-- 									<input type="text" id="linkedin" class="page-signin-form-control form-control" placeholder="LÀM 4 SCOOP KHÔNG CÓ THỜI GIAN XEM !" readonly>
 -->
                </fieldset>
